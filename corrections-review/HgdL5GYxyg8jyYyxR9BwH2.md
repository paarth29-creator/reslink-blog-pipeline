...
Word count: original 1970 -> corrected 1960

CHANGES APPLIED:
CAPEX vs LCOE mismatch applied; Unit definitions missing applied; Unsupported 20% discount rate applied; Storage premium too generic applied
...
TL;DR: Utility‑scale solar farms remain one of the most cost‑effective ways to add new electricity capacity. 2026 cost estimates still hinge on three core drivers: equipment (modules and balance‑of‑system), land and site preparation, and financing terms. Current CAPEX for utility‑scale solar typically ranges from $800,000 to $1,200,000 per MW, varying by region and project size.

## What Shapes the Utility‑Scale Solar Cost Figure

CAPEX = $/MW or $/W installed. LCOE = $/MWh over the project life. WACC/discount rate affects LCOE but is not the same thing as EPC cost per MW. Keep these explicitly distinct wherever they appear.
...
1. **Applying regional cost multipliers.** Adjust base‑case unit costs for local labor rates, land prices, and import duties.

1. **Running financing scenarios.** IEA’s 2022 cost‑of‑capital data show that the weighted average cost of capital (WACC) for utility‑scale solar projects typically ranges between 4 % and 8 % depending on market risk perception.

1. **Embedding contingency and risk buffers.** EPCs add a contingency line (often 5‑10 % of total CAPEX) to cover unforeseen site conditions, permitting delays, or commodity price swings.
...
When paired with battery storage, the overall $/MW rises due to battery capital cost and additional balance‑of‑system components. Lazard’s LCOE+ includes a separate “Levelized Cost of Storage” section. Storage cost impact depends on battery duration, power rating, chemistry, PCS, grid interconnection, augmentation, land, and market. State assumptions before quoting a percentage.
