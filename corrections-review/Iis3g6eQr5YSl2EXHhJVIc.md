...
Word count: original 2311 -> corrected 2332
...
***   - **Correction 3 (Stale India solar target):** “India crossed 100 GW of installed solar capacity in January 2025. As of 30 June 2026, MNRE reports 162.15 GW of cumulative solar capacity.” – These specific figures are not backed by any of the listed sources. The cited MNRE “Solar Overview” page is noted only for solar resource potential and policy context, and the Saur Energy article is referenced for Chinese investment trends and India’s 100 GW target, not for the actual achievement date or the 162.15 GW cumulative capacity. Introducing new, precise statistics without verifiable citations constitutes an unsupported replacement rather than a proper removal of the stale target.

CHANGES APPLIED:
Scope/title mismatch applied; 500 MW threshold overgeneralised applied; Stale India solar target applied; Old Railway reference framed as current applied; Environmental clearance overbroad applied; MNRE-approved vendor database overbroad applied

RETRY PASS (targeted at independently-verified problems): Removed promotional marker line [[PROMO_IMAGE_MARKER_DO_NOT_REMOVE_OR_EDIT_THIS_LINE]]
...
TL;DR: Setting up a solar plant in India in 2026 involves two parallel tracks. For projects that seek support under MNRE’s “Development of Solar Parks and Ultra‑Mega Solar Power Projects” scheme, EPCs must meet the scheme‑specific requirements (including the 500 MW minimum park size or a justified exception), prepare a Detailed Project Report (DPR), and can access central financial assistance (CFA) for DPR preparation and grid‑connectivity costs. For all other solar plants — rooftop, commercial & industrial (C&I), captive, group‑captive, open‑access, and standalone utility projects — the process follows the general steps of land acquisition, DISCOM/STU/CTU grid‑connectivity approvals, CEIG/CEA clearances, open‑access or Power Purchase Agreement (PPA) arrangements, ALMM/BIS compliance, metering, commissioning, and state‑level approvals. EPCs should align their workflow with the appropriate track to ensure compliance and eligibility for incentives.
...
The pathway from concept to operational solar plant follows a structured sequence of eligibility verification, documentation, and regulatory approvals. The steps differ depending on whether the project is pursued under the MNRE scheme or through the general route.

#### **1. Confirm Eligibility**

- **Scheme‑specific projects** – Verify that the project location lies within a State or Union Territory that has not exhausted its allocated park quota and that the proposed capacity meets the 500 MW minimum, or prepare a justification for a smaller park if land fragmentation is an issue.

- **General‑process projects** – Confirm land ownership or lease rights, ensure compliance with state‑level renewable‑energy targets, and determine the appropriate market (open‑access or PPA) for selling power.

#### **2. Prepare a Detailed Project Report (DPR)** *(scheme‑specific only)*  
...
#### **3. Secure Central Financial Assistance (CFA)** *(scheme‑specific only)*  
...
- **Environmental and land‑related approvals** – Depend on site conditions. Solar PV projects may require land conversion, forest or wildlife clearance, local permits, water‑use permissions, or transmission‑line approvals where applicable. EPCs should verify the project‑specific approval route rather than assume a universal EIA requirement.  
...
- Obtain the Certificate of Commercial Operation (CCO) from the SLDC, triggering revenue generation under the Power Purchase Agreement (PPA) or open‑access market arrangement.

#### **7. Post‑Commissioning Monitoring**

- Implement remote monitoring dashboards for real‑time performance data, enabling predictive maintenance and compliance reporting to MNRE or the relevant state authority.
...
- **DPR Alignment (scheme‑specific):** Ensure that the DPR reflects realistic costings, a viable financing structure, and a grid‑interconnection plan that meets CERC technical specifications.
...
- **Supply‑Chain Traceability:** Verify ALMM applicability for modules, BIS certification for applicable equipment, inverter/grid‑code compliance, and any DCR or domestic‑content requirement linked to the specific scheme, tender, or subsidy route.

- **Reporting to MNRE or State Authority:** Submit quarterly progress reports that detail construction milestones, financial utilization of CFA (if applicable), and any deviations from the approved DPR.

By embedding these practices, EPCs reduce the likelihood of project stoppage, ensure timely CFA releases (where relevant), and position themselves for future tender opportunities such as the Indian Railways solar portfolio.
...
#### **Railways’ Solar Initiatives**

Indian Railways has previously announced solar deployment plans on railway land and traction infrastructure. However, these should not be presented as a fresh 2026 tender unless a current official tender notice is cited.
...
- **✅ Verify eligibility:** Confirm park size and State quota for scheme projects; follow general land and grid‑connectivity checks for other projects.  
- **✅ Prepare DPR (if applicable):** Include solar resource data, cost breakdown and financing plan.  
- **✅ Apply for CFA (scheme‑specific):** Submit DPR to MNRE, track ₹25 lakh assistance and grid‑connectivity funds.  
- **✅ Secure clearances:** Environmental, land, transmission and water approvals as required by the specific site.  
- **✅ Execute procurement:** Source components in line with ALMM, BIS, and other applicable requirements; adhere to IEC standards.  
- **✅ Commission and operate:** Achieve CCO, implement monitoring, submit quarterly reports to MNRE or the relevant state authority.
...
India crossed 100 GW of installed solar capacity in January 2025. As of 30 June 2026, MNRE reports 162.15 GW of cumulative solar capacity. The broader national target is 500 GW of non‑fossil capacity by 2030.
...
- Press Information Bureau – “Ministry of Railways” – https://www.pib.gov.in/PressReleasePage.aspx?PRID=1636765 – supports claims on Indian Railways’ solar initiatives.  
