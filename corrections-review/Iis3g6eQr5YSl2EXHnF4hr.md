...
Word count: original 2124 -> corrected 2146

CHANGES APPLIED:
1. Applied correction to degradation calculation sentence (both body and FAQ). 
2. Updated LCOE sentence to reflect increased LCOE with degradation. 
3. Revised warranty wording to clarify it is not a replacement date. 
4. Replaced contract renegotiation claim with appropriate wording. 
5. No generic First Solar assumption found, skipped.
...
**If a project targets 5 MWp, a simple 0.5% annual linear degradation assumption implies roughly 87.5% of initial output after 25 years, or about 4.38 MWp‑equivalent before considering other performance factors.** EPCs therefore size the initial DC capacity higher and embed the degradation assumption into the guarantee, often linking the guarantee to the manufacturer’s 25‑year warranty to limit liability.
