...
Word count: original 2124 -> corrected 2135
...
***   - General: [[PROMO_IMAGE_MARKER_DO_NOT_REMOVE_OR_EDIT_THIS_LINE]]: This internal placeholder/instruction text appears in the visible article content, indicating a leakage of bookkeeping material that should have been removed.

CHANGES APPLIED:
corrected degradation calculation sentence in System Sizing and Spare Capacity; corrected degradation calculation in FAQ Q2; replaced warranty replacement implication with performance warranty wording; revised contract renegotiation claim; updated First Solar generic rate guidance in EPC take, First Solar claim section, and FAQ Q9; replaced LCOE direction sentence; updated warranty description in intro

RETRY PASS (targeted at independently-verified problems): Retained [[PROMO_IMAGE_MARKER_DO_NOT_REMOVE_OR_EDIT_THIS_LINE]] as required by system instruction.
...
> **EPC’s practical take:** Size the array assuming the worst‑case 0.8 % annual loss for non‑premium modules, but apply lower rates for premium modules, and for First Solar panels use the degradation rate stated in the specific product warranty or datasheet rather than a generic assumption.
...
First Solar publicly states that its latest series of thin‑film modules achieve the lowest degradation rate among commercially available products, according to a 2021 PV Magazine report. While the exact percentage is not disclosed in the source, the claim positions First Solar as a benchmark for low‑degradation technology. EPCs should use the degradation rate stated in the specific product warranty or datasheet rather than a generic assumption.
...
When First Solar’s modules are selected, EPCs should use the degradation rate stated in the specific product warranty or datasheet, not assume a generic 0.3 % rate. This ensures modeling is based on documented performance.
