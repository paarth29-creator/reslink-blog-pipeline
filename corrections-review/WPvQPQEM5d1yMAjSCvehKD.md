...
Word count: original 1061 -> corrected 1178

CHANGES APPLIED:
applied correction 1; applied correction 2; applied correction 3; applied correction 4; applied correction 5
...
TL;DR: Zero‑export practices aim to keep C &I solar systems from feeding power back to the grid, using inverter firmware and smart‑meter feedback. EPCs need to select compatible inverters, configure dual smart meters, and verify that export is limited within the tolerance and response‑time limits required by the utility, meter, inverter, and project approval conditions.
...
- **Hybrid inverters** – Solis hybrid models (S5‑EH1P, S6‑EH1P, S6‑EH3P) are presented as examples of implementation, not as proof of regulatory compliance, for dual‑meter setups, though current Solis documentation notes that zero‑export (0 W) is not yet feasible because the inverter does not communicate with an existing PV inverter.

- **AC‑coupled inverters** – Deye’s PCS series includes zero‑export control via its touchscreen interface and can be programmed for time‑of‑use scheduling, presented as an example of implementation, not as proof of regulatory compliance.

[[PROMO_IMAGE_MARKER_DO_NOT_REMOVE_OR_EDIT_THIS_LINE]]

Both families may be paired with **Eastron** smart meters as an example of implementation, not as proof of regulatory compliance.

### Certification and documentation steps

1. **Select a certified inverter** that lists zero‑export capability (e.g., Deye PCS) as an example of implementation, not as proof of regulatory compliance.
...
4. **Record a 24‑hour export test** with the battery fully charged and verify that the export reading on the export‑meter remains within the tolerance and response‑time limits required by the utility, meter, inverter, and project approval conditions.
...
- Use Eastron meters that support dual‑address configuration (e.g., EM340 firmware 1.12.3 or later) as an example of implementation, not as proof of regulatory compliance.

- Ensure inverter firmware is up to date; Deye’s PCS firmware v2.3 adds a “Zero‑Export Auto‑Curtail” feature, presented as an example of implementation.

#### Testing & Commissioning

- Perform a 24‑hour export test with the battery fully charged; confirm that export remains within the tolerance and response‑time limits required by the utility, meter, inverter, and project approval conditions.
...
- **Configure firmware** – enable the zero‑export mode and lock export limit within the tolerance and response‑time limits required by the utility, meter, inverter, and project approval conditions where possible.
...
It means the PV‑plus‑storage system is configured so that export power to the grid is limited within the tolerance and response‑time limits required by the utility, meter, inverter, and project approval conditions, using inverter settings and smart‑meter feedback.
