...
Word count: original 1801 -> corrected 1803

CHANGES APPLIED:
1. East-west density overclaim - applied
2. South orientation absolute - not found, skipped
3. Unsupported MNRE orientation recognition - applied
4. Unsupported feed-in tariff tier wording - applied
5. Glare overclaim - applied
...
- Community projects that adopt east‑west layouts experience smoother export profiles, easing the net‑metering reconciliation process and the tariff treatment depends on the applicable jurisdiction, DISCOM, net‑metering/gross‑metering rules, and consumer category.
