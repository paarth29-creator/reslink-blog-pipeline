...
Word count: original 1801 -> corrected 1831

CHANGES APPLIED:
East-west doubles row density. -> applied
South always yields more total kWh. -> applied
Unsupported MNRE orientation recognition -> applied (claim removed)
Net-metering higher feed-in tariff tiers. -> applied
East-west has lower glare. -> applied
...
In addition to market drivers, regulatory guidance is adapting. 
